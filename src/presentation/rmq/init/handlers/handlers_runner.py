...
class HandlersRunner:
    ...
    def __skip_exception_handler(
        ...
        message = (
            f"The use_case '{handler_name}' has been "
    ...
    def __skip_consumer(self, handler: AbstractRmqHandler, exc: Exception) -> None:
        ...
        message = (
            ...
            f"use_case '{handler_name}' with message: {error_str}"
        )
    ...
    def __exception_handler(self, handler: AbstractRmqHandler, exc: Exception):
        ...
        message = f"The use_case '{handler_name} was stopped with an error: {error_str}"
    ...
    def __exception_create_handler(
        ...
        message = (
            f"It didn't work to create a use_case '{handler_name}'. "
            f"An error occurred while creating the use_case: {error_str}"
        )
        extra = self.__create_extra(handler_name, trace)
