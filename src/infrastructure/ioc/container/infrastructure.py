...
class InfrastructureContainer(containers.DeclarativeContainer):
    ...
    course_repo: Factory[ICourseRepo] = providers.Factory(CourseRepo, postgres_session_maker.provided)
    lesson_repo: Factory[ILessonRepo] = providers.Factory(LessonRepo, postgres_session_maker.provided)
